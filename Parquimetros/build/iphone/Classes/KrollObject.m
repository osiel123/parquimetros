...
//@interface ParquimetrosObject : NSObject
//@end

@interface ParquimetrosObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ParquimetrosObject class]])
		{
			for (NSString *key in [[(ParquimetrosObject*)o modules] allKeys])
			{
