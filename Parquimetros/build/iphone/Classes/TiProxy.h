...
//Rare exceptions to indicate a bug in the _parquimetros code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Parquimetros proxies.
 */
