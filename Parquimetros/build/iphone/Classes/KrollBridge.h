...
@interface ParquimetrosObject : KrollCoverageObject {
#else
@interface ParquimetrosObject : KrollObject {
#endif
@private
...
extern NSString * Parquimetros$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ParquimetrosObject *_parquimetros;
    KrollObject* console;
	BOOL shutdown;
