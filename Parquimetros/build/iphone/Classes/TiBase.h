...
// in simulator we redefine to format for Parquimetros Developer console
...
{\
	NSString * exceptionName = [@"org.parquimetros." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.parquimetros";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIParquimetrosNativeItemNone = -1, 
	UIParquimetrosNativeItemSpinner = -2,
	UIParquimetrosNativeItemProgressBar = -3,
	
	UIParquimetrosNativeItemSlider = -4,
	UIParquimetrosNativeItemSwitch = -5,
	UIParquimetrosNativeItemMultiButton = -6,
	UIParquimetrosNativeItemSegmented = -7,
	
	UIParquimetrosNativeItemTextView = -8,
	UIParquimetrosNativeItemTextField = -9,
	UIParquimetrosNativeItemSearchBar = -10,
	
	UIParquimetrosNativeItemPicker = -11,
	UIParquimetrosNativeItemDatePicker = -12,
	
	UIParquimetrosNativeItemInfoLight = -13,
	UIParquimetrosNativeItemInfoDark = -14,
	
	UIParquimetrosNativeItemDisclosure = -15,
	
	UIParquimetrosNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Parquimetros instances of
